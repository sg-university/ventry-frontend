  ...
  return (
    <Authenticated>
      <div className="page item-transaction-history">
        <MessageModal/>
        {modal == 'insertModal' && <TransactionInsertModalComponent setModal={setModal} getAllTransaction={getAllTransaction} getAllTransactionItems={getAllTransactionItems}/>}
        {modal == 'viewModal' && <TransactionViewModalComponent setModal={setModal} transactionController={transactionController}/>}
        {modal == 'updateModal' && <TransactionUpdateModalComponent setModal={setModal} transactionController={transactionController}/>}
