    ...
    return (
        <Authenticated>
            <div className="page inventory-control-history">
                <MessageModal/>
                {modal == 'insertModal' && <InventoryControlInsertModalComponent setModal={setModal}
                                                                                 getAllInventoryControl={getAllInventoryControl}/>}
                {modal == 'viewModal' && <InventoryControlViewModalComponent setModal={setModal}
                                                                             inventoryControlController={inventoryControlController}
                                                                             getAllInventoryControl={getAllInventoryControl}/>}
                {modal == 'updateModal' &&
                    <InventoryControlUpdateModalComponent setModal={setModal} inventoryControl={inventoryControl}
                                                          setInventoryControl={setInventoryControl}
                                                          getAllInventoryControl={getAllInventoryControl}/>}
                        ...
                        <div key={val.id} className="card">
                            ...
                            <div className="content">
                                ...
                                <div className="right">
                                    <div className="total">
                                        <div
                                            className="text">{calculateQuantity(val.quantityBefore, val.quantityAfter)}</div>
                                    </div>
                                </div>
                            </div>
                            <div className="control">
