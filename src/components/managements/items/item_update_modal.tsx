...
import PatchOneItemByIdRequest
    from "@/models/value_objects/contracts/requests/managements/items/patch_one_by_id_request";
...
function MainComponent(props) {
    ...
    const handleUpdateSubmit = (values: any,) => {
                ...
                <div className="items form">
                    <div className="table-ic">
                        <table className="table ">
                            ...
                            <tbody>
                            {currentItemBundleMaps && currentItemBundleMaps.map((val, idx) => {
                                return (
                                    <tr key={idx}>
                                        <td>{val.subItemId}</td>
        ...
        function ItemBundleForm(props) {
            ...
            const fetchCurrentItemBundleMaps = () => {
                itemBundleService.readAllBySuperItemId({
                    superItemId: currentItem?.id
                }).then((response) => {
                    const content: Content<ItemBundleMap[]> = response.data;
                    dispatch(pageSlice.actions.configureItemManagement({
                                ...
                                <Form>
                                    <div className="row">
                                        <fieldset className="form-group pb-2">
                                            ...
                                            <Field type="text" name="superItem" className="form-control select-item"
                                                   disabled/>
                                            <ErrorMessage
                                                name="superItem"
                                                component="div"
                                    ...
                                    <div className="row">
                                        ...
                                        <fieldset className="form-group pb-2">
                                            ...
                                            <Field type="number" name="bundle_quantity"
                    ...
                    <Nav variant="tabs" onSelect={(eventKey) => handleSelectModalMenu(eventKey)}>
                        <Nav.Item>
                            <Nav.Link eventKey="main"
                                      className={currentModalMenu == "main" ? "active" : "menu"}>Main</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link eventKey="itemBundle"
                                      className={currentModalMenu == "itemBundle" ? "active" : "menu"}>Items
                                Bundle</Nav.Link>
                        </Nav.Item>
                    </Nav>
